    ...
    try {
      ...
      if (user) {
        router.push('/dashboard');
         ...
         setError('Failed to create account. The email might already be in use or the password is too weak.');
      }
    } catch (err: any) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-headline">Create your QuantEasy Account</CardTitle>
